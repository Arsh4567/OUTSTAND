...
-- Run every minute. The function only enqueues jobs inside their five-minute window,
-- making it safe to poll frequently while still delivering one event per user/job/day.
