...
export const POSITIVES: {
...
}[] = [
  {
    ...
    emoji: "🎯",
    points: 20,
    description: "Unbroken, hyper-focused session",
  },
  {
    key: "outstand",
    label: "Outstand Challenge",
    emoji: "⚡",
    points: 15,
    description: "10 minutes of intentional growth",
  },
  {
    key: "workout",
    ...
    emoji: "🏋️",
    points: 15,
    description: "Move your body, wire your brain",
  },
  {
    key: "read",
    label: "Deep Reading",
    emoji: "📚",
    points: 10,
    description: "Slow-dopamine skill practice",
  },
  {
    key: "meditation",
    label: "Mind Reset",
    emoji: "🧘",
    points: 10,
    description: "5+ minutes of pure stillness",
  },
  {
    key: "sunlight",
    label: "Morning Sun",
  ...
  },
  {
    ...
    emoji: "🌙",
    points: 20,
    description: "Hit your target wind-down time",
  },
  {
    key: "water",
    ...
    emoji: "💧",
    points: 10,
    description: "At least 2L of water today",
  },
  {
    key: "journal",
    label: "Daily Log",
    emoji: "📓",
    points: 10,
    description: "End-of-day mental offload",
  },
  {
    key: "all_habits",
    label: "Perfect Day",
    emoji: "🏆",
    points: 15,
    description: "Completed the entire routine",
  },
];
...
export const NEGATIVES: {
...
}[] = [
  {
    ...
    emoji: "📱",
    points: -25,
    description: "Caught in the algorithm spiral",
  },
  {
    key: "broke_focus",
    label: "Fractured Focus",
    emoji: "💥",
    points: -20,
    description: "Abandoned a deep work block",
  },
  {
    key: "snoozed",
    label: "Snoozed Alarm",
    emoji: "⏰",
    points: -15,
    description: "Started the day with hesitation",
  },
  {
    key: "slept_late",
    label: "Sleep Deficit",
    emoji: "🌒",
    points: -15,
    description: "Stayed up past target bedtime",
  },
  {
    key: "skipped_habits",
    label: "Zero Momentum",
    emoji: "🚫",
    points: -15,
    description: "Skipped all daily targets",
  },
  {
    key: "missed_reflection",
    label: "Unclosed Loop",
    emoji: "🌫️",
    points: -10,
    description: "Missed the evening check-in",
  },
];

const POSITIVE_POINTS_MAP = new Map(POSITIVES.map((p) => [p.key, p.points]));
const NEGATIVE_POINTS_MAP = new Map(NEGATIVES.map((n) => [n.key, n.points]));
...
export function generateInsights(
  ...
  // Positive Triggers
  if (has("pomodoro", safePos))
    out.push("You held your attention through deep work. This is a massive dopamine win.");
  if (has("outstand", safePos))
    out.push(
      "You conquered an Outstand challenge today. Small intentional acts compound massively.",
    );
  if (has("workout", safePos))
    out.push("Physical training rewires your reward system in your favor. Great momentum.");
  if (has("meditation", safePos))
    out.push("Stillness trained your baseline back down. You are in control of your attention.");
  if (has("sleep_on_time", safePos))
    out.push("Sleeping on time is the highest-leverage reset protocol. You protected tomorrow.");
  if (has("sunlight", safePos))
    out.push("Morning sunlight set your circadian clock. Expect sharper focus today.");

  // Friction Triggers
  if (has("scrolling", safeNeg))
    out.push(
