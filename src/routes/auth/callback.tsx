      ...
      <div className="min-h-screen bg-[#05070d] px-4 py-10 text-white">
        <div className="mx-auto flex min-h-[80vh] max-w-md items-center justify-center">
          <div className="w-full rounded-[28px] border border-red-400/15 bg-white/[0.04] p-7 text-center shadow-2xl backdrop-blur-2xl">
            <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl border border-red-400/20 bg-red-400/10 text-red-300">
            ...
            <button
              ...
              className="mt-6 h-11 w-full rounded-xl bg-white text-sm font-bold text-slate-950 transition hover:bg-slate-200"
            >
              Return to sign in
            </button>
          </div>
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-[#05070d] px-4 text-white">
      <div className="text-center">
        <div className="mx-auto grid h-16 w-16 place-items-center rounded-3xl border border-cyan-300/20 bg-cyan-300/10 shadow-[0_0_45px_rgba(34,211,238,.16)]">
