...
const navigationActions = [
  ...
  { id: "chat", label: "Open chat", to: "/chat", icon: MessageSquare, keywords: "messages ai" },
...
export function QuickActions() {
  ...
  return (
    <>
      ...
      >
        <CommandIcon className="h-3.5 w-3.5 text-cyan-300" />
      ...
      <CommandDialog
        ...
        description="Move through OUTSTAND, start work, and jump to any system without leaving the keyboard."
      >
        <Command>
          <CommandInput autoFocus placeholder="Search pages, actions, goals..." />
          <CommandList>
                  ...
                  {group.actions.map((action) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {active ? <span className="text-[10px] font-semibold uppercase tracking-wider text-cyan-300/60">Open</span> : null}
                      </CommandItem>
                    );
                  })}
                </CommandGroup>
