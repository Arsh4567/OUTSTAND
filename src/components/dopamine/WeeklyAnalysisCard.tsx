    ...
    <section className="rounded-[2rem] border border-indigo-400/15 bg-[#0a0c1c]/80 p-6 shadow-2xl backdrop-blur-3xl sm:p-8">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-4">
          ...
          <div><div className="mb-1 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.25em] text-indigo-300"><Sparkles className="h-3.5 w-3.5" /> Intelligence</div><h2 className="text-2xl font-black tracking-tight text-white">Why did my momentum change?</h2><p className="mt-1 text-sm text-slate-400">OUTSTAND looks for patterns in your recent scores and daily actions.</p></div>
        </div>
