...
export function useAppState() {
  ...
  // Realtime profile events can be frequent. Cache only the authenticated ID in a ref so
  // each event is handled locally instead of triggering another auth/network lookup.
  useEffect(() => {
    let active = true;
