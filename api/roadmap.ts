...
async function callGroq(prompt: string) {
  ...
  // Groq primary. Keep the model configurable so it can be changed without code changes.
  // Do not use an OpenAI-owned model. Default to Meta Llama 3.3 70B.
