...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Use a database RPC that derives user_id from auth.uid(). This keeps the
  // write tied to the verified session and avoids depending on a server-role
  // secret or on the client supplying a user_id that RLS must trust.
